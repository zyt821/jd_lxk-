/*
8.13-8.25 骁龙品牌日 [jd_xiaolong.js]
...
[task_local]
#8.13-8.25 骁龙品牌日
18 9,19 13-25 8 * jd_xiaolong.js, tag=8.13-8.25 骁龙品牌日, enabled=true

================Loon==============
[Script]
cron "18 9,19 13-25 8 *" script-path=jd_xiaolong.js,tag=8.13-8.25 骁龙品牌日

===============Surge=================
8.13-8.25 骁龙品牌日 = type=cron,cronexp="18 9,19 13-25 8 *",wake-system=1,timeout=3600,script-path=jd_xiaolong.js

============小火箭=========
8.13-8.25 骁龙品牌日 = type=cron,script-path=jd_xiaolong.js, cronexpr="18 9,19 13-25 8 *", timeout=3600, enable=true
*/
...
luckydrawStatus = $.isNode() ? (process.env.xiaolong_luckydraw ? process.env.xiaolong_luckydraw : `${luckydrawStatus}`) : ($.getdata('xiaolong_luckydraw') ? $.getdata('xiaolong_luckydraw') : `${luckydrawStatus}`);
...
!(async () => {
    ...
    $.shareUuid = '06490a7be7414de88de633eab6a84ba1'
