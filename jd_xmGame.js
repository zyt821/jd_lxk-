...
[task_local]
#8.13-8.31 小米-星空大冒险
31 8,22 13-31 8 * jd_xmGame.js, tag=8.13-8.31 小米-星空大冒险, enabled=true

================Loon==============
[Script]
cron "31 8,22 13-31 8 *" script-path=jd_xmGame.js,tag=8.13-8.31 小米-星空大冒险

===============Surge=================
8.13-8.31 小米-星空大冒险 = type=cron,cronexp="31 8,22 13-31 8 *",wake-system=1,timeout=3600,script-path=jd_xmGame.js

============小火箭=========
8.13-8.31 小米-星空大冒险 = type=cron,script-path=jd_xmGame.js, cronexpr="31 8,22 13-31 8 *", timeout=3600, enable=true
*/
...
let stopIndex = 11
if($.isNode()){
    if (process.env.xmGame_stopIndex && process.env.xmGame_stopIndex != "") {
        stopIndex = process.env.xmGame_stopIndex;
    }
}
message = ""
!(async () => {
    ...
    $.shareUuid = 'b30d6be438814e2da2ee854df0fbe088'
